...
use backend\models\search\AuditoriaSearch;
...
class AuditoriaController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        // En tu controlador u otro lugar
        $registros = Auditoria::find()->registrosConPrecioSuperiorAlPromedio()->all();


        return $this->render('index', [
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
            'registros' => $registros, // Pasar los registros a la vista
        ]);
    }
    ...
    {
        if (($model = Auditoria::findOne(['id' => $id])) !== null) {
            return $model;
        }
